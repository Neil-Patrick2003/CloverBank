 ...
 * Props:
 * - mode: "create" | "edit"
 * - action: string (POST or PUT endpoint)
 * - initialValues: object (matches form shape)
 */
export default function CustomerForm({ mode = "create", action, initialValues }) {
    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="border rounded-2xl shadow p-5 bg-white">
        ...
        <div className="space-y-3">
          <div>
            <InputLabel value="First Name" htmlFor="first_name" />
            <TextInput
              id="first_name"
              type="text"
          ...
          <div>
            <InputLabel value="Last Name" htmlFor="last_name" />
            <TextInput
              id="last_name"
              type="text"
          ...
          <div>
            <InputLabel value="Birthdate" htmlFor="date_of_birth" />
            <TextInput
              id="date_of_birth"
              type="date"
          ...
          <div>
            <InputLabel value="Gender" htmlFor="gender" />
            <select
              id="gender"
              value={data.gender}
          ...
          <div>
            <InputLabel value="Occupation" htmlFor="occupation" />
            <TextInput
              id="occupation"
              type="text"
          ...
          <div>
            <InputLabel value="Source of Income" htmlFor="income_source" />
            <TextInput
              id="income_source"
              type="text"
      ...
      <div className="border rounded-2xl shadow p-5 bg-white">
        ...
        <div className="space-y-3">
          ...
          <div>
            <InputLabel value="Phone Number" htmlFor="phone_number" />
            <TextInput
              id="phone_number"
              type="tel"
        ...
        <div className="space-y-3">
          <div>
            ...
            <TextInput
              ...
              disabled={isEdit} // usually immutable after creation
            />
            <InputError message={errors.username} />
          </div>

          <div>
            <InputLabel value="Account Type" htmlFor="account_type" />
            <select
              id="account_type"
          ...
          <div>
            <InputLabel value="Initial Deposit" htmlFor="initial_deposit" />
            <TextInput
              id="initial_deposit"
              inputMode="decimal"
              type="number"
      ...
      <div className="border rounded-2xl shadow p-5 bg-white">
        ...
        <div className="space-y-3">
          <div>
            <InputLabel value={isEdit ? "New Password (optional)" : "Password"} htmlFor="password" />
            <TextInput
              id="password"
              type="password"
              value={data.password}
      ...
      <div className="col-span-1 md:col-span-2 flex justify-end">
        ...
        >
          {processing ? (isEdit ? "Saving..." : "Creating...") : isEdit ? "Save Changes" : "Create Customer"}
        </button>
      </div>
    </form>
  );
